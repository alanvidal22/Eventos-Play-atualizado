  ...
  <a class="navbar-brand" href="#"><img src="./img/images (1)X.jpg" style="width:40%;"></a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
       ...
       <li class="nav-item">
          <a class="nav-link" href="formulario de criar evento.html" style="color:#fff;">Registrar Evento</a>
        </li>
        </li>
       <li class="nav-item">
          <a class="nav-link" href="cad_eventos.html" style="color:#fff;">Criar Evento</a>
        </li>
        <li class="nav-item">
...
<h1>Promotor(a) seja bem vindo ao nosso aplicativo</h1>
<div class="container-sm">
<h1>Seus eventos</h1>
